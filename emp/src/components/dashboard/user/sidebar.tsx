...
const menuItems = [
    ...
    { icon: Sparkles, label: 'Create Report', path: '/dashboard/create-report' },
    { icon: FileText, label: 'My Reports', path: '/dashboard/my-reports' },
    { icon: Files, label: 'Drafts', path: '/dashboard/drafts' },
